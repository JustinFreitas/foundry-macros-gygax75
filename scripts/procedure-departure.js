// Procedure: Departure / Return to Game
//
// Interactive checklist for the "Basic Game and Expedition Departure" section of
// the DM Procedures runbook. Macro rows run the matching world macro and tick;
// manual rows are checkboxes for steps with no macro. This file only orchestrates
// — every macro it names already exists in the world.
//
...
const steps = [
    { section: "Setup" },
    { macro: "Show Party Sheet" },
    { manual: "Populate the party sheet (deploy party / set marching order)." },
    { macro: "Duty XP", label: "Assign Duty XP roles" },

    { section: "Review Characters in World" },
    { manual: "Review: days since last play, chest/inn/food cost, retainer costs, stabling." },
    { macro: "Upkeep Costs", label: "Pay upkeep & apply healing" },

    { section: "Rations & Inventory" },
    { macro: "Expired Ration Removal - Party", label: "Purge expired rations" },
    { manual: "Players re-enter the world; verify all pogs on table." },
    { manual: "Players select memorized spells where applicable." },
    { manual: "Players make any last-minute expedition purchases." },
    { manual: "Purchases & inventory ready check." },
    { macro: "Container Checker", label: "Verify PC/NPC inventory storage" },
    { macro: "Container Checker with Mounts", label: "Verify storage incl. mounts (if mounted)" },

    { section: "Mounts (if using mounts)" },
    { macro: "Riders Encumbrance Update", label: "Update rider encumbrance" },
    { macro: "Mount Speed Update", label: "Update mount speed" },

    { section: "Final Prep" },
    { manual: "Copy players to the Combat Page." },
    { macro: "Speed Report", label: "Verify & note party speed" },
    { macro: "Dungeon Best Abilities", label: "Verify & note dungeon bests" },
    { manual: "Final ready check." }
];

await runProcedure("Departure / Return to Game", steps);
