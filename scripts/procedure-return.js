// Procedure: End of Game / Return (Basic)
//
// Interactive checklist for the "Basic Game and Expedition Return" section of the
// DM Procedures runbook: treasure resolution, XP, retainer pay, and teardown.
//
...
const steps = [
    { section: "Teardown of Combat Page" },
    { manual: "Remove pogs from the Combat Page; clear any writing on maps." },

    { section: "Treasure Resolution" },
    { manual: "Players add all found treasure to the Treasure Pile." },
    { macro: "Party Found to Pile", label: "Move (Found) items to the pile" },
    { manual: "Players decide if haggling is performed (one roll per treasure type)." },
    { macro: "Haggling", label: "Roll haggling" },
    { manual: "Input total coins found into the Value columns." },
    { macro: "Found Treasure Check - Party & Mounts", label: "Verify found treasure removed" },
    { macro: "Gem Values", label: "Roll gem values" },
    { macro: "Jewellery Value", label: "Roll jewellery values" },
    { manual: "Input gem/jewellery values (apply haggling %; default 80% if none)." },

    { section: "XP & Split" },
    { manual: "Distribute treasure XP via the Party Sheet XP tool." },
    { macro: "Treasure Split", label: "Distribute treasure split" },
    { manual: "Players declare buy-backs (gems/jewellery 200gp+) and magic-item split." },
    { macro: "Pay Party Retainers", label: "Deduct retainer fees x days" },
    { macro: "Duty XP Reset", label: "Remove duty-XP roles" },

    { section: "Teardown" },
    { manual: "Clear magic effects/bonuses; players strip & stow animal gear." },
    { manual: "Return animal pogs to stables (or delete); return PCs to inn, delete retainer pogs." },
    { macro: "Container Checker with Mounts", label: "Verify inventory removed/stowed" },
    { macro: "Riders Encumbrance Reset - Party", label: "Reset rider encumbrance" },
    { macro: "Mount Speed Update", label: "Reset mount speed" },
    { macro: "Clear Party Sheet", label: "Clear the party sheet" },

    { section: "Records (external)" },
    { manual: "Update Kill Log for successful expeditions (reputation)." },
    { manual: "Update Characters-in-World departure date; clear expedition date." }
];

await runProcedure("End of Game / Return", steps);
