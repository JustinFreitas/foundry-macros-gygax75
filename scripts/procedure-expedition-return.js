// Procedure: Expedition Return (Expert play variant)
//
// Interactive checklist for the "On Expedition" return variant of the DM
// Procedures runbook: recovery days, provisions, paid-through dates. Treasure is
// stowed in a wagon by the Organizer rather than split immediately.
//
...
const steps = [
    ...
    { section: "Treasure (stowed, not split)" },
    { manual: "Players add all found treasure to the Treasure Pile." },
    { macro: "Party Found to Pile", label: "Move (Found) items to the pile" },
    { manual: "Organizer removes items from the pile and stows them in a wagon." },
    { macro: "Found Treasure Check - Party & Mounts", label: "Verify found treasure removed" },

    { section: "Recovery" },
    { manual: "Players decide recovery days (spells per day; natural healing day 2)." },
    { manual: "Update Characters-in-World expedition date to 1 day after recovery." },
    { manual: "Update Discord to reflect the day of the campaign." },

    { section: "Review Characters in World" },
    { manual: "Review: days for recovery, chest cost, owed retainer wages." },
    { macro: "Upkeep Costs", label: "Pay upkeep & apply healing" },
    { macro: "Pay Party Retainers", label: "Deduct retainer fees x days" },

    { section: "Provisions" },
    { macro: "Expedition Provisions", label: "Deduct provisions used in recovery" },
    { manual: "Update Discord thread with provisions remaining." },

    { section: "Teardown" },
    { manual: "Clear magic effects/bonuses." },
    { macro: "Clear Party Sheet", label: "Clear the party sheet" },
    { manual: "Update Kill Log; set Characters-in-World departure date." }
];

await runProcedure("Expedition Return (Expert)", steps);
